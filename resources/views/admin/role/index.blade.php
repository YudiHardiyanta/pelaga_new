...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <a href="{{ url('admin/role/tambah') }}"><button class="btn btn-primary">Tambah Role</button></a>
                </div>
                @if(session('success'))
                <div class="row mt-2">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card-body">
                            <table id="role" class="table table-hover table-bordered table-striped dt-responsive nowrap"
