        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card-body">
                            <table id="pengguna" class="table table-hover table-bordered table-striped dt-responsive nowrap"
    ...
    $('#pengguna').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                name: 'id',
                render: function(data, type, row) {
                    return '<a href="/admin/pengguna/edit/' + data + '" class="btn btn-primary btn-sm">Edit</a>';
                },
                orderable: false,
                searchable: false
            },
